...
export default function LoginForm({ logoUrl, storeName }: LoginFormProps) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#001a38] via-[#002147] to-[#00315f] p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-[#0056b3]/20 border border-[#0056b3]/30 mb-4 backdrop-blur-sm overflow-hidden">
            {logoUrl ? (
              <img src={logoUrl} alt={storeName || 'Logo'} className="w-full h-full object-contain p-2" />
            ) : (
              <Lock className="w-10 h-10 text-[#add8e6]" />
            )}
          </div>
